            ...
            <section className="relative w-full h-[1080px]">
                ...
                <div className="absolute top-0 left-0 w-full">
                    <div className="w-full absolute inset-0 h-[1080px]">
                        ...
                        <div className=" absolute inset-0 md:w-[740px] h-[150px] top-60 sm:top-[352px] sm:left-5 lg:left-[199px] px-5 md:flex items-center justify-center">
                            <p className="sm:text-[60px] text-[30px] text-[800] text-white">Empowering Businesses with AI & ML Innovations</p>
                        </div>
                        <div className='px-5 sm:block absolute inset-0 top-96 sm:top-[494px] sm:w-[670px] h-[82px] sm:left-5 lg:left-[199px] sm:mt-[22px] '>
                        ...
                        <div className='absolute inset-0 top-[496px] sm:top-[593px] sm:w-[670px] h-[82px] px-5 sm:left-5 lg:left-[199px] sm:mt-[17px] '>
