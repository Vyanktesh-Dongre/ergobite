    ...
    return (
        <>
            <div className="w-full mx-auto flex justify-center">
                <div className="md:w-[80%] gap-10 px-2 md:pl-24 md:pr-10 py-[7%] bg-black grid grid-cols-1 md:grid-cols-2 rounded-[20px]" style={{ boxShadow: '0px 20px 24.7px 0px #E1E5EB80' }}>
                    ...
                    <div className="md:flex items-center mb-5 sm:mb-0 px-5 gap-10">
                        ...
                        <Image className="w-[70%] h-[60%] mx-auto" src={img1} alt="company logo" />
                        </div>
                    </div>
                </div>
            </div>
