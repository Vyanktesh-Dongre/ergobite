        ...
        <div className="bg-[#EFF5FD] pt-[53px] 3xl:max-w-[1920px] 3xl:mx-auto">
            <div className=" text-center">
                ...
                <div className="w-full text-center justify-center pt-[26px]">
                    <p className=" px-1 md:px-[15%]">The client is a leading player in the refinery industry, committed to leveraging cutting-edge technologies to 
                ...
                <div className="relative w-full flex justify-center items-center py-[73px]">
                    <div className="relative w-[80%] h-[323px]">
                        ...
                        <div className="absolute top-[100px] left-0 xl:top-[147px] xl:left-[106px] xl:w-[741px] w-full text-left p-10">
